...
interface ApproveTajweedFormModalProps {
  enrolment: TajweedEnrolment
}

const TAJWEED_LEVELS: string[] = ["1", "2", "3", "4"]

export const ApproveTajweedFormModal = ({ enrolment }: ApproveTajweedFormModalProps) => {
  ...
  return (
    <React.Fragment>
      ...
      >
        <ModalOverlay />
        <ModalContent>
          <ModalCloseButton onClick={clearStateAndCloseModal} />
          <ModalBody>
                ...
                <Stack spacing="4" divider={<StackDivider />}>
                  ...
                  <FieldGroup title="Address">
                    <VStack width="full" spacing="6">
                      ...
                      <FormControl
                        id="address.suburb"
                        isInvalid={!!errors?.address?.suburb?.message}
                      >
                      ...
                      <FormControl
                        id="address.postcode"
                        isInvalid={!!errors?.address?.postcode?.message}
                      >
          ...
          <ModalFooter>
            <Button colorScheme="blue" onClick={clearStateAndCloseModal} data-testid="close-btn">
              Close
            </Button>
          </ModalFooter>
        </ModalContent>
